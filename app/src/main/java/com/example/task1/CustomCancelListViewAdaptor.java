...
public class CustomCancelListViewAdaptor extends BaseAdapter {
    private ArrayList<ListviewModel> list = new ArrayList<>();
    private Context context ;
    public CustomCancelListViewAdaptor(Context context , ArrayList<ListviewModel> list) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View v = convertView.inflate(this.context,R.layout.refuse_list,null);
