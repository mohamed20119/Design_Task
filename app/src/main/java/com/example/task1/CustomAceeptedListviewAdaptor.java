...
public class CustomAceeptedListviewAdaptor extends BaseAdapter {
    private ArrayList<ListviewModel> list = new ArrayList<>();
    private Context context ;
    public CustomAceeptedListviewAdaptor(Context context , ArrayList<ListviewModel> list) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View v = convertView.inflate(this.context,R.layout.accepted_list,null);
