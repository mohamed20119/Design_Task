...
public class AcceptedFragmet extends Fragment {
    private ArrayList<ListviewModel> list;
    private ListView listView;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View v= inflater.inflate(R.layout.accepted_content,container,false);
        init_ListView(v);
        return v;
    }
    public void init_ListView(View v)
    {
        ...
        CustomAceeptedListviewAdaptor adaptor = new CustomAceeptedListviewAdaptor(v.getContext(),this.list);
